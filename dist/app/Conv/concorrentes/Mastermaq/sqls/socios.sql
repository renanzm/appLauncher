...
BPM_DADOSSOCIO.IDPESSOA,
(SELECT BPM_PESSOA.NOMEPESSOA FROM NG.DBO.BPM_PESSOA WHERE BPM_PESSOA.IDPESSOA = BPM_DADOSSOCIO.IDPESSOA) AS NOME,
BPM_DADOSSOCIO.CARGOSOCIO,
BPM_DADOSSOCIO.PROFISSAO,
