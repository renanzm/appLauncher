...
CASE
    WHEN ISDATE(emp.dtexpedicaoctps) = 0 THEN CAST('1900-01-01' AS DATE)
    WHEN CAST(emp.dtexpedicaoctps AS DATE) < '1900-01-01' THEN CAST('1900-01-01' AS DATE)
    WHEN CAST(emp.dtexpedicaoctps AS DATE) > '9999-12-31' THEN CAST('1900-01-01' AS DATE)
    ELSE CAST(emp.dtexpedicaoctps AS DATE)
